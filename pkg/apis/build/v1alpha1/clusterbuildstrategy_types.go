...
func (s ClusterBuildStrategy) GetBuildSteps() []BuildStep { return s.Spec.BuildSteps }

// GetParams returns the spec params of the build strategy
func (s ClusterBuildStrategy) GetParams() []Param { return s.Spec.Params }
